# modal run ./runner.py::build_and_sweep_mpi
...
image = (
    modal.Image.from_registry("pytorch/pytorch:2.3.1-cuda12.1-cudnn8-devel")
        ...
        .add_local_dir("./cuda_src", "/workspace/src")
)
...
@app.function(image=image, gpu="A100-40GB:8", timeout=60*30)
def build_and_sweep_mpi(src_name: str = "fa2_fwd_mp.cu", np_max: int = 8):
